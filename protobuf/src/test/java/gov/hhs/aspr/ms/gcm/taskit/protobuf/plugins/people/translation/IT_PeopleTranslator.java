...
public class IT_PeopleTranslator {
    ...
    public void testPeopleTranslator() {
        ...
        PeoplePluginData actualPluginData = taskitEngineManager.readAndTranslate(filePath.resolve(fileName),
                PeoplePluginDataInput.class, ProtobufTaskitEngineId.JSON_ENGINE_ID);
